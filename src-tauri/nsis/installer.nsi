...
!define MUI_WELCOMEPAGE_TITLE "DEPLOY KNULL"
!define MUI_WELCOMEPAGE_TITLE_3LINES
!define MUI_WELCOMEPAGE_TEXT "Install the KNULL command center for Navaneeth Reddy on this machine.$\r$\n$\r$\nThis deployment packages the desktop shell, configures shortcuts, and prepares the runtime required to launch KNULL.$\r$\n$\r$\nPress Next to continue."
!define MUI_FINISHPAGE_TITLE "KNULL DEPLOYED"
!define MUI_FINISHPAGE_TITLE_3LINES
!define MUI_FINISHPAGE_TEXT "KNULL is installed and ready.$\r$\n$\r$\nYou can launch the command center now or create a desktop shortcut before closing this installer."
!define MUI_FINISHPAGE_RUN_TEXT "Launch KNULL now"
